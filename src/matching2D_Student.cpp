...
void descKeypoints(vector<cv::KeyPoint> &keypoints, cv::Mat &img, cv::Mat &descriptors, string descriptorType, std::vector<float>& desc_time)
{
    ...
    desc_time.push_back(t_f);

    
}

// Detect keypoints in image using the traditional Shi-Thomasi detector
void detKeypointsShiTomasi(vector<cv::KeyPoint> &keypoints, cv::Mat &img, std::vector<float>& det_time, bool bVis)
{
    ...
    // vector<int> det_time;
    // det_time.push_back(t_f);

    // for (int i = 0; i<det_time.size(); ++i)
    // cout << det_time[i] << endl;
...
// void Print_all (vector<double> &det_time, vector<double> &desc_time, vector <int> &match_F)
// {

//     cout << "$$$$$$$$$$$$$$$$$$$$$$$$$$"<< endl;

//     for (int i = 0; i<match_F.size(); ++i)
//     cout <<match_F[i]<< endl;

//     cout << "@@@@@@@@@@@@@@@@@@@@@@@@@@@"<< endl;

//     for (int i = 0; i<det_time.size(); ++i)
//     cout <<"decriptor extraction time :  "<<det_time[i]<< endl;

//     cout << "!!!!!!!!!!!!!!!!!!!!!!!!!!"<< endl;

//     for (int i = 0; i<desc_time.size(); ++i)
//     cout <<"decriptor extraction time :  "<< desc_time[i]<< endl;
